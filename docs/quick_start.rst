...
This boilerplate has the **DJANGO_KEY** settings variable hidden.
...
The default language for this Project is **English**, and we use internationalization to trans the text into Catalan.
...
For example, if you want to use German you shold include::
